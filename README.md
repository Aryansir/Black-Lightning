...
<h2 align="center"><b>Owner: <a href="https://telegram.dog/krish1303y">Aɳɱσʅ Sɾιʋαʂƚαʋα 🇮🇳</a></b></h2>
<br>
...
[![Deploy on Railway](https://railway.app/button.svg)](https://railway.app/new/template?template=https%3A%2F%2Fgithub.com%2FKeinShin%2FBlack-Lightning&envs=APP_ID%2CAPI_HASH%2CSTRING_SESSION%2CCMD_HNDLR%2CCOMBINED_GROUP_ID%2CSUDO_USERS%2CSUDO_CMD%2CTG_BOT_TOKEN_BF_HER%2CTG_BOT_USER_NAME_BF_HER%2CALIVE_NAME%2CLIGHTNING_ALV_IMG&APP_IDDesc=Get+this+value+from+my.telegram.org%21+Please+do+not+steal&API_HASHDesc=Get+this+value+from+my.telegram.org%21+Please+do+not+steal&STRING_SESSIONDesc=Get+this+value+by+running+python3+telesetup.py+locally+or+https%3A%2F%2Freplit.com%2F%40Paramatin%2FLightning-Repl%23main.py+online.&COMBINED_GROUP_IDDesc=This+is+all+in+one+group+id.+just+add+%40Missrose_bot+to+your+private+group+and+do+%2Fid&SUDO_USERSDesc=Users+you+want+to+give+access+to+your+bot.+%28Don%27t+allow+unknown+people%29&SUDO_CMDDesc=SET+THIS+TO+,&TG_BOT_TOKEN_BF_HERDesc=Needed+for+inline+buttons+maker.+Make+a+bot+at+http%3A%2F%2Ftelegram.dog%2FBotFather+and+get+the+token+of+your+bot.+Get+it+else+.help+won%27t+work.&TG_BOT_USER_NAME_BF_HERDesc=Needed+for+inline+buttons+maker.+Make+a+bot+at+http%3A%2F%2Ftelegram.dog%2FBotFather+and+get+the+username+of+your+bot.+Get+it+else+.help+won%27t+work.&ALIVE_NAMEDesc=Put+Your+Name+you+can+use+designer+fonts&CMD_HNDLRDefaultDesc=Enter+Here+&LIGHTNING_ALV_IMGDesc=ENTER+YOUR-PHOTO+OR+VIDEO+LINK+WHICH+U+WANT+TO+SET+FOR+.alive+CMD+⚡⚡⚡.)
