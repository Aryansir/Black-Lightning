...
BUTTON = [[Button.url("Repos", f"https://github.com/KeinShin/Black-Lightning"), Button.url(f"Support", "https://t.me/lightning_support_group")]]

@tgbot.on(events.NewMessage(pattern="^/alive", func=lambda e: e.sender_id == bot.uid))
async def _(event):
    await tgbot.send_file(event.chat_id, PM_IMG, buttons=BUTTON, caption=pm_caption)
